...
import com.akash.contactspro.databinding.ListItemContactsBinding
import kotlinx.android.synthetic.main.list_item_contacts.view.*

class ContactsAdapter(val context: Context, private val contactsClickListener: ContactsClickListener): ListAdapter<Contact, RecyclerView.ViewHolder>
